...
const LANDING_FEATURES = [
  ...
  },
  {
    ...
    desc: "Create unique projects with tailored system guidelines. Set 'Marketing Mode' or 'Code Review Mode' once.",
    icon: <FolderCog className="w-6 h-6 text-red-400" />,
    ...
    points: [
      ...
      'Maintain consistent tone and rules',
    ],
  },
];
      ...
      >
        ...
        >
          <button
            ...
            className={`absolute top-4 left-4 ${theme.textMuted} hover:${theme.text}`}
          >
      ...
      <div className="flex-1 flex flex-col relative min-w-0">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => setView('landing')}
              className={`text-xs ${theme.textMuted} hover:${theme.text} px-3 py-1`}
            >
              Log out
            </button>
            {isPremium && (
